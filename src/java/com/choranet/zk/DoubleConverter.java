...
public class DoubleConverter implements TypeConverter {
    ...
    public Object coerceToUi(java.lang.Object val,
        ...
        if(val == null)
              return null;
        Double unDouble = (Double) val;
        String stringDouble = unDouble.toString();
        int newSize = stringDouble.indexOf(".") + 3;
        if (stringDouble.length()> newSize)
            stringDouble = stringDouble.substring(0, newSize);
        return stringDouble;
    }
}
